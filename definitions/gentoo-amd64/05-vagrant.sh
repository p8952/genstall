...
EOF
$CHROOT chmod -R 0700 /mnt/gentoo/home/vagrant/.ssh/
$CHROOT chmod -R 0600 /mnt/gentoo/home/vagrant/.ssh/authorized_keys
$CHROOT chown -R vagrant:vagrant /mnt/gentoo/home/vagrant/.ssh/
